...
type TripSearchRequest struct {
	// Basic search
	Origin      string `form:"origin" json:"origin" validate:"required"`
	Destination string `form:"destination" json:"destination" validate:"required"`
	Date        string `form:"date" json:"date" validate:"required"` // Format: DD/MM/YYYY

	// Advanced filters
	DepartureTimeStart *string              `form:"departure_time_start" json:"departure_time_start,omitempty"` // Format: HH:MM
	DepartureTimeEnd   *string              `form:"departure_time_end" json:"departure_time_end,omitempty"`     // Format: HH:MM
...
type BusDetail struct {
	...
	BusType    ConstantDisplay   `json:"bus_type"`
	TotalSeats int               `json:"total_seats"`
