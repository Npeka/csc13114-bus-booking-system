...
export default function AdminBusesPage() {
  ...
  const {
    ...
    queryKey: ["buses", page, pageSize, search],
    queryFn: () =>
      listBuses({
        page,
        page_size: pageSize,
  ...
  return (
    <>
      <PageHeaderLayout>
        <PageHeader
          title="Quản lý xe"
          description="Quản lý thông tin và cấu hình ghế cho các xe buýt"
        />
        <Button
        ...
        <CardContent className="pt-6">
          <div className="flex items-center gap-4">
            <div className="flex-1">
              <Input
                placeholder="Tìm kiếm theo biển số hoặc mẫu xe..."
                value={search}
                onChange={(e) => {
              ...
              search && (
                <div className="py-12 text-center">
                  ...
                  <p className="text-muted-foreground">
                    Không có xe nào phù hợp với từ khóa &ldquo;{search}&rdquo;
                  </p>
                </div>
              )}
          </CardContent>
      ...
      {busesData && busesData.buses.length > 0 && (
        <div className="mt-6">
          <Pagination
            currentPage={page}
            totalPages={busesData.total_pages || 1}
            pageSize={pageSize}
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              và có thể ảnh hưởng đến các chuyến xe đang sử dụng xe này.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
