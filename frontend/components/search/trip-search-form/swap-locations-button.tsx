...
export function SwapLocationsButton({ onClick }: SwapLocationsButtonProps) {
  return (
    <Button
      ...
      size="icon-sm"
      onClick={onClick}
      className="group hidden lg:flex absolute left-1/2 top-1/2 z-10 size-9 -translate-x-1/2 -translate-y-1/2 rounded-full shadow-elevated transition-transform duration-300 hover:scale-105"
